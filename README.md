...
```buildoutcfg
#linux
go build -o terraform-provider-m3_v0.6.6
#windows
go build -o terraform-provider-m3_v0.6.6.exe
```

After that move it to user plugins directory (see https://www.terraform.io/docs/plugins/basics.html)
```buildoutcfg
#linux
mv terraform-provider-m3_v0.6.6 ~/.terraform.d/plugins
#windows
move terraform-provider-m3_v0.6.6.exe %APPDATA%\terraform.d\plugins
```
